                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select name="product_name" id="product_name_select" class="form-select select2-tags" required data-placeholder="-- Cari / Pilih Produk Gudang atau Ketik Nama Produk --">
                                        ...
                                        @php
                                            $currName = old('product_name', $product->product_name);
                                            $gudangNames = [];
                                        @endphp
                                        @if(isset($gudangProducts))
                                            @foreach($gudangProducts as $gProd)
                                                ...
                                                <option value="{{ $itemName }}" 
                                                    ...
                                                    {{ $currName === $itemName ? 'selected' : '' }}>
                                                    {{ $itemName }} (SKU Gudang: {{ $skuName }})
                                                </option>
                                            @endforeach
                                        @endif
                                        @if($currName && !in_array($currName, $gudangNames))
                                            <option value="{{ $currName }}" selected>{{ $currName }}</option>
                                        @endif
                                    </select>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="category" id="category_select" class="form-select select2-tags" data-placeholder="-- Pilih / Ketik Kategori --">
                                        ...
                                        @php
                                            $currCat = old('category', $product->category);
                                            $catNames = [];
                                        @endphp
                                        @if(isset($categories))
                                            @foreach($categories as $cat)
                                                @php $catNames[] = $cat->name; @endphp
                                                <option value="{{ $cat->name }}" {{ $currCat === $cat->name ? 'selected' : '' }}>{{ $cat->name }}</option>
                                            @endforeach
                                        @endif
                                        @if($currCat && !in_array($currCat, $catNames))
                                            <option value="{{ $currCat }}" selected>{{ $currCat }}</option>
                                        @endif
                                    </select>
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="sub_category" id="sub_category_select" class="form-select select2-tags" data-placeholder="-- Pilih / Ketik Sub Kategori --">
                                        ...
                                        @php
                                            $currSubCat = old('sub_category', $product->sub_category);
                                            $subCatNames = [];
                                        @endphp
                                        @if(isset($subCategories))
                                            @foreach($subCategories as $subCat)
                                                @php $subCatNames[] = $subCat->name; @endphp
                                                <option value="{{ $subCat->name }}" data-category="{{ $subCat->category?->name }}" {{ $currSubCat === $subCat->name ? 'selected' : '' }}>
                                                    {{ $subCat->name }} {{ $subCat->category ? '('.$subCat->category->name.')' : '' }}
                                                </option>
                                            @endforeach
                                        @endif
                                        @if($currSubCat && !in_array($currSubCat, $subCatNames))
                                            <option value="{{ $currSubCat }}" selected>{{ $currSubCat }}</option>
                                        @endif
                                    </select>
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="brand" id="brand_select" class="form-select select2-tags" data-placeholder="-- Pilih / Ketik Brand --">
                                        ...
                                        @php
                                            $currBrand = old('brand', $product->brand);
                                            $brandNames = [];
                                        @endphp
                                        @if(isset($brands))
                                            @foreach($brands as $br)
                                                @php $brandNames[] = $br->name; @endphp
                                                <option value="{{ $br->name }}" {{ $currBrand === $br->name ? 'selected' : '' }}>{{ $br->name }}</option>
                                            @endforeach
                                        @endif
                                        @if($currBrand && !in_array($currBrand, $brandNames))
                                            <option value="{{ $currBrand }}" selected>{{ $currBrand }}</option>
                                        @endif
                                    </select>
                                </div>
                                <div class="col-md-12 mb-3">
