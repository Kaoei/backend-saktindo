...
[
    ...
    'pageTitle' => 'Supplier',
    'breadcrumb' => '<li class="breadcrumb-item"><a href="'.route('dashboard').'">Home</a></li><li class="breadcrumb-item"><a href="'.route('supplier.index').'">Supplier</a></li><li class="breadcrumb-item">Tambah Supplier</li>'
])
    ...
    <div class="col-xl-10 col-lg-11">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <div>
                    <h5 class="mb-1">Tambah Supplier Baru</h5>
                    <small class="text-muted">Tambahkan data supplier</small>
                </div>
